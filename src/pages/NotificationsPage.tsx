        ...
        <PageHeader 
          ...
          rightAction={
            <button 
              ...
              className="text-primary text-sm font-semibold px-3 py-1 rounded-lg hover:bg-primary/5 transition-colors"
            >
              Tandai dibaca
            </button>
          }
          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-1">
              <div className="flex justify-between items-start">
                <h3 className={`text-base ${notif.unread ? 'font-bold text-[#111827]' : 'font-semibold text-[#374151]'}`}>
                  {notif.title}
                </h3>
                {notif.unread && (
