...
export const BottomNavigationBar: React.FC<{ 
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 max-w-screen-md mx-auto bg-secondary h-20 flex items-center justify-between px-8 z-50 border-t border-gray-100">
      <NavItem 
        icon={<Home size={20} />} 
        label="Beranda" 
      ...
      >
        ...
        <span className="text-[10px] font-bold tracking-tight mt-1 text-[#5a5c5e]">
          Buat Quest
        </span>
      </div>
